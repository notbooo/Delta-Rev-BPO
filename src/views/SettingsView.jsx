        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <label className="block text-sm font-semibold text-slate-700 mb-2">
              Absolute Minimum Rate (JPY)
            </label>
            <input
              type="number"
              value={absoluteMinRate}
              onChange={(e) => setAbsoluteMinRate(parseInt(e.target.value, 10) || 0)}
            ...
            <p className="mt-2 text-xs text-slate-500 font-medium">
              The system will never recommend a rate below this floor.
            </p>
          </div>
          <div>
            <label className="block text-sm font-semibold text-slate-700 mb-2">
              Absolute Maximum Rate (JPY)
            </label>
            <input
              type="number"
            ...
            />
            <p className="mt-2 text-xs text-slate-500 font-medium">
              The system will never recommend a rate above this ceiling.
            </p>
          </div>
        </div>
